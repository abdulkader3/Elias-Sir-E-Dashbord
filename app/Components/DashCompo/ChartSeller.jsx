...
export default function ChartSeller() {
  ...
  return (
    <div className="w-full h-auto lg:h-[502px] dark:bg-gray-900 rounded-2xl py-4 lg:py-[18px] px-4 lg:px-6 m-2 sm:m-4 lg:m-[26px] relative shadow-sm">
      ...
      <div className="flex justify-between items-center border-b pb-4 lg:pb-6 border-b-[#e2e2ea] relative">
        ...
        <div ref={dropdownRef} className="relative">
          ...
          {/* Dropdown Menu */}
          {open && (
            <div className="absolute right-0 mt-3 w-40 dark:bg-gray-900 shadow-lg rounded-lg py-3.5 px-4 border-[#E8EDF2]">
