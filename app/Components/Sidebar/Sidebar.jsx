...
const Sidebar = ({ onLinkClick }) => {
    ...
    return (
        <div className="w-64 h-screen overflow-y-auto p-6 transition-colors duration-300">
            ...
            <div>
                ...
                <div className="space-y-3">
                    {/* Laptops */}
                    <div className="flex items-center justify-between text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white cursor-pointer">
                ...
                {/* Add category */}
                <div className="flex items-center gap-2 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white cursor-pointer mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            {/* Top Sellers Section */}
            <div>
                <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-4">Top Sellers</h3>
